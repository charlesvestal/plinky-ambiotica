...
MODULES="looper granular microloop reverb harmony bloom drift lfo dattorro"

{
    ...
    echo "#define AMB_NO_SHIMMER   // shimmer off: its 2 float read-heads cache-missed ~180us on-device (mic 390->210)"
    echo "#define AMB_NO_CLOUD   // cloud off: inaudible under the wash once shimmer was gone, but cost ~150us of cache-miss thrash at freeze (mic 360->190)"
