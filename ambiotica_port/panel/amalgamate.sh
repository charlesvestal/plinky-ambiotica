...

{
    ...
    echo "#define AMB_DATTORRO   // reverb = Dattorro plate (lush, long, ~48KB half-rate)"
    echo "#define AMB_NO_SHIMMER // microloop octave shimmer off — cache-miss cost, inaudible under the wash"
    echo "#define AMB_NO_CLOUD   // microloop freeze granular cloud off — cache-miss cost, inaudible under the wash"
